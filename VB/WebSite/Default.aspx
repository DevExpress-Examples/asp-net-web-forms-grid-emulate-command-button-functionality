...
<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="Test.Default" %>
...
<body>
	...
	<div>
		...
		<dx:ASPxGridView ID="grid" runat="server" DataSourceID="dataSource" KeyFieldName="CustomerID" ClientInstanceName="grid" Width="700px">
			<Columns>
